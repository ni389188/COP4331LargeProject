        ...
        <div className="bg-secondary">
            ...
            <CardDeck style={{ padding: "10px" }}>
                <h2 class="text-center" style={{ color: 'black' }}>
                    &nbsp;&nbsp;&nbsp;Here are a few examples of recipes you may find on our platform:
                </h2>
            </CardDeck>
            <br />
            <CardDeck style={{ padding: "10px" }}>
                ...
                <Card border="light">
                    ...
                    <Card.Body>
                        <Card.Text>
                            ...
                            Have no idea what to cook? Dinner-On-Demand can take in a few ingredients and help you find the perfect recipe.<br />
